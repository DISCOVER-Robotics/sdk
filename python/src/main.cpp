...
std::unique_ptr<arm::Robot<6>> createAgent(std::string direction = "down", std::string can_interface = "can0",
                                           double vel = M_PI, std::string end_mode = "newteacher",
                                           std::string bigarm_type = "OD", std::string forearm_type = "DM") {
  return std::make_unique<arm::Robot<6>>("", can_interface, direction, vel, end_mode, bigarm_type, forearm_type);
}
...
PYBIND11_MODULE(airbot, m) {
  ...
  m.attr("AIRBOT_PLAY_WITH_GRIPPER_URDF") = URDF_INSTALL_PATH + "airbot_play_with_gripper.urdf";
  ...
  py::class_<arm::Robot<6>, std::unique_ptr<arm::Robot<6>>>(m, "Robot", DOC(arm, Robot))
      ...
      .def("set_target_pose", py::overload_cast<const Frame &, bool, double, bool>(&arm::Robot<6>::set_target_pose),
           py::arg("target_pose"), py::arg("use_planning") = true, py::arg("vel") = M_PI, py::arg("blocking") = false,
      ...
      .def(
          ...
          py::arg("target_translation"), py::arg("target_rotation"), py::arg("use_planning") = true, py::arg("vel") = 1,
      ...
      .def("set_target_translation", &arm::Robot<6>::set_target_translation, py::arg("target_translation"),
           py::arg("use_planning") = true, py::arg("vel") = 1, py::arg("blocking") = false,
      ...
      .def("add_target_relative_translation", &arm::Robot<6>::add_target_relative_translation,
           py::arg("target_d_translation"), py::arg("use_planning") = true, py::arg("vel") = 1,
  ...
  m.def("create_agent", &createAgent, py::arg("direction") = "down", py::arg("can_interface") = "can0",
        py::arg("vel") = M_PI, py::arg("end_mode") = "newteacher", py::arg("bigarm_type") = "OD",
